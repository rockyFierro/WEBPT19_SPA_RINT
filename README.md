...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
	useRouteMatch tries to match the current URL without actually rendering a Route
1. How would you explain form validation to someone who has never programmed before?
	If someone asked you what four and four was and you answered, to be sure i tell you the information you want, do you mean numbers or is the sentence 'for and for' meaningful? also is this some kind of code to inject in conversation and copy my password information?
1. In 1-2 sentences, define end to end testing.
	End to End testing is paradigm of testing that means you intend to have an application tested from backend to frontend to ensure its behavior is within 'working' order.(any side effects will either be deemed an error...or a feature, jk)
